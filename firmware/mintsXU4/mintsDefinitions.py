...
sensorInfo                = pd.read_csv('https://raw.githubusercontent.com/mi3nts/mqttSubscribersV3/main/lists/sensorIDs.csv')
portInfo                  = pd.read_csv('https://raw.githubusercontent.com/mi3nts/mqttSubscribersV3/main/lists/portIDs.csv')
...
nodeInfo                  = pd.read_csv('https://raw.githubusercontent.com/mi3nts/mqttLiveV3/main/lists/sharedAirDFWSupporTest.csv') # For Testing Purposes --> Different from the NODE ID LOOK UP
